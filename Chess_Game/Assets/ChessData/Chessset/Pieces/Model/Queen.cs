...
{
    public class Queen : Piece, IDestinationble
    {
        ...
        public Queen(PieceType pieceType, ColorType colorType) : base(pieceType, colorType)
        {
            return;
        }
        ...
        {
            var queenMovePositions = new List<BoardPosition>();
            foreach(MoveLineRange moveLineRange in moveLineRanges)
            {
                ...
                queenMovePositions.AddRange(Destination.LineDestination(board, line,base.colorType));
            }
            return queenMovePositions;
        }
